PLUGIN.name = "Acid - Combine Module"
PLUGIN.description = "Hl2RP Combine module, contains features shared between OTA and CP."
...
/* -------------------------------------------------------------------------- */
/*                            Combine Visor Message                           */
/* -------------------------------------------------------------------------- */

if (SERVER) then
    util.AddNetworkString("AcidCombineVisorMessage")
    ...
    net.Receive("AcidCombineVisorMessage", function (len, ply)
...
if (CLIENT) then
    function PLUGIN:VisorMessage(message, color) 
        ...
        net.Start("AcidCombineVisorMessage")
